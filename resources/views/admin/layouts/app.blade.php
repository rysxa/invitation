...
<head>
    ...
    <meta name="description" content="niceWone - Wedding Invitation">
    ...
    <!-- Datatables -->
    <link href="{{ asset('assets/admin2/vendor/datatables/dataTables.bootstrap4.min.css') }}" rel="stylesheet">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; niceWone.com 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
